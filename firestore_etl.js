...
async function getLastSyncTime() {
    ...
    try {
        const [job] = await bq.query({ query: query });
...
async function runEtl() {
    try {
        ...
        // The insert method returns a job object, which is usually successful unless
        // there's an immediate, critical error.
        console.info(`Successfully submitted load job to BigQuery for ${stagingTableId}.`);
